...
\IfThisCommonLabelBaseOneOf{scrlayer-scrpage,scrextend,scrjura}{}{%
  ...
  \cite{latex:usrguide-historic} und \cite{latex:fntguide} zu entnehmen.%
}%
...
\cite{latex:usrguide-historic} oder \cite{latex:fntguide}. Auch
Farbumschaltungen wie \Macro{normalcolor} sind möglich (siehe
\cite{package:graphics} und \cite{package:xcolor}).%
...
\else%
  \ Die Verwendung anderer Anweisungen, inbesondere solcher, die
  ...
  \begin{desclist}
    ...
    \feentry{enumeratelabel}{%
      \ChangedAt{v3.44}{\Class{scrbook}\and \Class{scrreprt}\and
        \Class{scrartcl}}%
      Grundeinstellung für die voreingestellten Aufzählungsnummern der
      Umgebung \DescRef{\ThisCommonLabelBase.env.enumerate} (siehe
      \autoref{sec:maincls.lists}, \DescPageRef{maincls.env.enumerate})}%
    \feentry{footnote}{%
    ...
    \feentry{labelenumi}{%
      \ChangedAt{v3.44}{\Class{scrbook}\and \Class{scrreprt}\and
        \Class{scrartcl}}%
      Schriftart für die Verwendung in der Definition der Aufzählungsnummer
      \DescRef{\ThisCommonLabelBase.cmd.labelenumi} (siehe
      \autoref{sec:maincls.lists}, \DescPageRef{maincls.env.enumerate})}%
    \feentry{labelenumii}{%
      \ChangedAt{v3.44}{\Class{scrbook}\and \Class{scrreprt}\and
        \Class{scrartcl}}%
      Schriftart für die Verwendung in der Definition der Aufzählungsnummer
      \DescRef{\ThisCommonLabelBase.cmd.labelenumii} (siehe
      \autoref{sec:maincls.lists}, \DescPageRef{maincls.env.enumerate})}%
    \feentry{labelenumiii}{%
      \ChangedAt{v3.44}{\Class{scrbook}\and \Class{scrreprt}\and
        \Class{scrartcl}}%
      Schriftart für die Verwendung in der Definition der Aufzählungsnummer
      \DescRef{\ThisCommonLabelBase.cmd.labelenumiii} (siehe
      \autoref{sec:maincls.lists}, \DescPageRef{maincls.env.enumerate})}%
    \feentry{labelenumiv}{%
      \ChangedAt{v3.44}{\Class{scrbook}\and \Class{scrreprt}\and
        \Class{scrartcl}}%
      Schriftart für die Verwendung in der Definition der Aufzählungsnummer
      \DescRef{\ThisCommonLabelBase.cmd.labelenumiv} (siehe
      \autoref{sec:maincls.lists}, \DescPageRef{maincls.env.enumerate})}%
    ...
    \IfThisCommonLabelBase{scrlttr2}{%
      ...
      \begin{desclist}
        ...
        \feentry{enumeratelabel}{%
          ...
          Grundeinstellung für die voreingestellten Aufzählungsnummern der
          Umgebung \DescRef{\ThisCommonLabelBase.env.enumerate}
          (\autoref{sec:scrlttr2.lists},
          \DescPageRef{\ThisCommonLabelBase.env.enumerate})}%
        ...
        \feentry{itemizelabel}{%
          ...
          Umgebung \DescRef{\ThisCommonLabelBase.env.itemize} (siehe
          \autoref{sec:scrlttr2.lists},
          \DescPageRef{\ThisCommonLabelBase.env.itemize})}%
        \feentry{labelenumi}{%
          \ChangedAt{v3.44}{\Class{scrlttr2}}%
          Schriftart für die Verwendung in der Definition der
          Aufzählungsnummer \DescRef{\ThisCommonLabelBase.cmd.labelenumi}
          (siehe \autoref{sec:scrlttr2.lists},
          \DescPageRef{\ThisCommonLabelBase.env.enumerate})}%
        \feentry{labelenumii}{%
          \ChangedAt{v3.44}{\Class{scrlttr2}}%
          Schriftart für die Verwendung in der Definition der
          Aufzählungsnummer \DescRef{\ThisCommonLabelBase.cmd.labelenumii}
          (siehe \autoref{sec:scrlttr2.lists},
          \DescPageRef{\ThisCommonLabelBase.env.enumerate})}%
        \feentry{labelenumiii}{%
          \ChangedAt{v3.44}{\Class{scrlttr2}}%
          Schriftart für die Verwendung in der Definition der
          Aufzählungsnummer \DescRef{\ThisCommonLabelBase.cmd.labelenumiii}
          (siehe \autoref{sec:scrlttr2.lists},
          \DescPageRef{\ThisCommonLabelBase.env.enumerate})}%
        \feentry{labelenumiv}{%
          \ChangedAt{v3.44}{\Class{scrlttr2}}%
          Schriftart für die Verwendung in der Definition der
          Aufzählungsnummer \DescRef{\ThisCommonLabelBase.cmd.labelenumiv}
          (siehe \autoref{sec:scrlttr2.lists},
          \DescPageRef{\ThisCommonLabelBase.env.enumerate})}%
        \feentry{labelinglabel}{%
          Label, also das optionale Argument der
