...
\KOMAProvidesFile{tocbasic-de.tex}
                 [$Date: 2023-09-08 21:57:09 +0200 (Fri, 08 Sep 2023) $
...
oder \Package{listings}\IndexPackage{listings}, die eigene Verzeichnisse
...
\important{\href{https://www.ctan.org/pkg/scrhack}{\Package{scrhack}}} enthält
übrigens Patches für mehrere Pakete wie \Package{float}\IndexPackage{float}
oder \Package{listings}\IndexPackage{listings}, damit deren Verzeichnisbefehle
...
zur Verfügung. Für weitere Informationen siehe \cite{pkg:scrhack:manual}.%
\EndIndexGroup
