...
\LaTeX~2.09 sei zumindest \cite{latex:usrguide} und ebenfalls
\cite{latex:usrguide-historic} empfohlen. Auch das Studium des einen oder
anderen Buches zu \LaTeX{} wird empfohlen.  Literaturempfehlungen finden sich
beispielsweise in \cite{DANTE:FAQ}. Der Umfang von \cite{DANTE:FAQ} ist
ebenfalls erheblich. Dennoch wird darum gebeten, sich einen groben Überblick
darüber zu verschaffen und es bei Problemen ebenso wie \iffree{diese
    Anleitung}{dieses Buch} zu konsultieren.
