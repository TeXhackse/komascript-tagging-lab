...
\KOMAProvidesFile{common-lists-de.tex}%
                 [$Date: 2025-06-04 18:44:23 +0200 (Wed, 04 Jun 2025) $
...
\IfThisCommonLabelBase{scrextend}{\iffalse}{\csname iftrue\endcsname}
  ...
  \iffalse % Umbruchoptimierungstext
    Die Benutzer einer unbeliebten Textverarbeitung nennen diese Form der
    Liste auch gerne \emph{Bulletpoints}. Vermutlich können sie sich nicht
    vorstellen, dass je nach Ebene auch ein anderes Zeichen als ein fetter
    Punkt zur Einleitung eines Stichpunkts verwendet werden kann. %
  \fi%
  ...
  Element \FontElement{labelitemii} verwendet zusätzlich \Macro{bfseries}.
  Die Voreinstellung von \FontElement{itemizelabel} selbst ist
  \Macro{normalfont}.%
  ...
  Die einzelnen Stichpunkte der Umgebung werden mit
...
\begin{lstcode}
 ...
 \end{lstcode}
  ...
  Die
  Schriftart\Index{Schrift>Art}\IfThisCommonLabelBase{scrlttr2}{\ChangedAt{v3.44}{\Class{scrlttr2}\and
      \Package{scrletter}}}{\ChangedAt{v3.44}{\Class{scrbook}\and
      \Class{scrreprt}\and \Class{scrartcl}}} der Nummern beziehungsweise
  Label für die einzelnen Ebenen kann außerdem bei den \KOMAScript-Klassen mit
  ...
  \FontElement{labelenumii}\important{\FontElement{labelenumii}},
  \FontElement{labelenumiii}\important{\FontElement{labelenumiii}} und
  \FontElement{labelenumiv}\important{\FontElement{labelenumiv}} geändert
  werden. In der Voreinstellung verwenden diese alle die Schrifteinstellung
  für Element
  \FontElement{enumeratelabel}\important{\FontElement{enumeratelabel}}. Die
  Voreinstellung für \FontElement{enumeratelabel} selbst ist leer, also keine
  ...
  \EndIndex{FontElement}{enumeratelabel} Die einzelnen Stichpunkte werden
  wieder mit \Macro{item} eingeleitet.%
  \IfThisCommonFirstRun{\iftrue}{%
